...
A brief description of what `batterylimiter` does and who it's for. This project contains the application `batterylimiter` and the library `batterylimiterlib`.
